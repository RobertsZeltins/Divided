...
namespace Water2DTool
{
    ...
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        public void Move(float move, bool crouch, bool jump)
        {
            ...
            {
                if (use2DColliders)
                    m_Rigidbody2D.linearVelocity = new Vector3(move * m_MaxSpeed, m_Rigidbody2D.linearVelocity.y, 0);
                else
                    m_Rigidbody.linearVelocity = new Vector2(move * m_MaxSpeed, m_Rigidbody.linearVelocity.y);
            }
